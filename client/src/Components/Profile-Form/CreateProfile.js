...
const CreateProfile = ({ createProfile, history }) => {
  ...
  // variable function called onChange if this name changes - change the name inside of onChange..(same with onSubmit)
  ...
  return (
    <Fragment>
      ...
      <form className="form" onSubmit={(e) => onSubmit(e)}>
        ...
        {/* now we can click on button and make the buttom appear and disappear.. */}
        { displaySocialInputs && (
            <Fragment>
